...
def values_match(
    ...
    *,
    ...
    words_a = [_canon_word(w) for w in _content_words(left, strip_vital_noise=numerical)]
    words_b = [_canon_word(w) for w in _content_words(right, strip_vital_noise=numerical)]
